...
public class SpriteMesh_Managed : IEZLinkedListItem<SpriteMesh_Managed>, ISpriteMesh
{
	...
	public SpriteManagerEZ manager
	{
		...
		set
		{
			...
			this.m_material = this.m_manager.GetComponent<Renderer>().sharedMaterial;
	...
	public virtual void Init()
	{
		...
		if (!this.m_sprite.uvsInitialized)
		{
			this.m_sprite.InitUVs();
			this.m_sprite.uvsInitialized = true;
		}
	...
	public SpriteManagerEZ m_manager;
