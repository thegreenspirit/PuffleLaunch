...
public class EZTransition
{
	...
	public void RemoveSubSubject(GameObject go)
	{
		...
		EZLinkedListNode<GameObject> ezlinkedListNode = this.subSubjects.Current;
		...
		IL_006E:
		this.subSubjects.Current = ezlinkedListNode;
	}
	...
	public void OnAnimEnd(EZAnimation anim)
	{
		...
		EZLinkedListNode<EZAnimation> ezlinkedListNode2 = this.runningAnims.Current;
		...
		IL_00A1:
		this.runningAnims.Current = ezlinkedListNode2;
	...
	public void End()
	{
		...
		if (this.runningAnims.Rewind())
		{
			...
			do
			{
				EZLinkedListNode<EZAnimation> ezlinkedListNode = this.runningAnims.Current;
				EZAnimation val = ezlinkedListNode.val;
				if (val != null)
				{
	...
	public void StopSafe()
	{
		...
		if (this.runningAnims.Rewind())
		{
			...
			{
				EZLinkedListNode<EZAnimation> ezlinkedListNode2 = this.runningAnims.Current;
				EZAnimation val = ezlinkedListNode2.val;
				if (val != null)
				{
					val.CompletedDelegate = null;
				...
				this.runningAnims.Remove(ezlinkedListNode2);
				this.idleAnims.Add(ezlinkedListNode2);
				ezlinkedListNode2.val = null;
			}
			while (this.runningAnims.MoveNext());
			this.forcedStop = false;
			this.CallEndDelegates();
		}
		this.runningAnims.Current = ezlinkedListNode;
	}
