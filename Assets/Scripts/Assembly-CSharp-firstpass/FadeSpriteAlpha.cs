...
public class FadeSpriteAlpha : EZAnimation
{
	...
	{
		this.type = EZAnimation.ANIM_TYPE.FadeSpriteAlpha;
	}
	...
	public static FadeSpriteAlpha Do(SpriteRoot sprt, EZAnimation.ANIM_MODE mode, Color begin, Color dest, EZAnimation.Interpolator interp, float dur, float delay, EZAnimation.CompletionDelegate startDel, EZAnimation.CompletionDelegate del)
	{
		FadeSpriteAlpha fadeSpriteAlpha = (FadeSpriteAlpha)EZAnimator.instance.GetAnimation(EZAnimation.ANIM_TYPE.FadeSpriteAlpha);
		fadeSpriteAlpha.Start(sprt, mode, begin, dest, interp, dur, delay, startDel, del);
		return fadeSpriteAlpha;
	}

	public static FadeSpriteAlpha Do(SpriteRoot sprt, EZAnimation.ANIM_MODE mode, Color dest, EZAnimation.Interpolator interp, float dur, float delay, EZAnimation.CompletionDelegate startDel, EZAnimation.CompletionDelegate del)
	{
		FadeSpriteAlpha fadeSpriteAlpha = (FadeSpriteAlpha)EZAnimator.instance.GetAnimation(EZAnimation.ANIM_TYPE.FadeSpriteAlpha);
