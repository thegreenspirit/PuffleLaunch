...
public class BHUIPanel : UIPanel, IUIPanelExtension
{
	public event BHUIPanel.ActivatePanelHandler activatePanel;

	public event BHUIPanel.DeactivatePanelHandler deactivatePanel;
