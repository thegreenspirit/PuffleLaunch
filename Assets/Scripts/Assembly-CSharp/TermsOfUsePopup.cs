...
{
	public TermsOfUsePopup(GameObject aRefObj)
		: base(aRefObj)
	{
		...
		this.mo_termsOfUseList = new TermsOfUseList(aRefObj, this.mo_scrollableListRectInfo, ScrollableGUI.ScrollDirection.eVertical);
		if (ResolutionManager.Instance.LayoutSize == ResolutionManager.eLayoutSize.eIPad)
		{
	...
	private void CreateLabels()
	{
		base.LabelData = new GUIDefines.LabelData[]
		{
			new GUIDefines.LabelData
			{
				...
				content = new GUIDefines.ContentInfo
				{
					text = LocalizationManager.Instance.GetString("TXT_TOU")
				},
	...
	private TermsOfUseList mo_termsOfUseList;
