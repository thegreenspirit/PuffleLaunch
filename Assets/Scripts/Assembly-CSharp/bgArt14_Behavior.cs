...
public class bgArt14_Behavior : MonoBehaviour
{
	private void Start()
	{
		base.transform.Find("InstructionText").GetComponent<TextMesh>().text = LocalizationManager.Instance.GetString("TXT_Instructions");
